...
import logi.modules.sql.global_bans_sql as sql
from logi.modules.sql.users_sql import get_user_com_chats
from logi import (
    DEV_USERS,
    EVENT_LOGS,
    OWNER_ID,
...
from logi.modules.helper_funcs.misc import send_to_list
